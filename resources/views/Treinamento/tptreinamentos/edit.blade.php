         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Digite um novo nome para o tipo de treinamento:</strong>
                    <br><br>
                    <input type="text" name="nome_tptreinamento" value="{{ $tptreinamento->nome_tptreinamento }}" class="form-control" placeholder="Digite aqui o novo tipo de treinamento..." maxlength="80">
                </div>
            </div>
