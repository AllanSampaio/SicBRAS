         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Digite um novo nome para a especificação de treinamento:</strong>
                    <br><br>
                    <input type="text" name="nome_espectreinamento" value="{{ $espectreinamento->nome_espectreinamento }}" class="form-control" placeholder="Digite aqui o novo nome da especificação de treinamento..." maxlength="80">
                </div>
            </div>
