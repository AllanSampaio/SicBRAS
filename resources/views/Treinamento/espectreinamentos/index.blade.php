...
@section('content')
    ...
    <table id="espectreinamentos_table" class="table table-bordered" style="width:100%">
        <thead>
        <tr>
            <th><center>N°</center></th>
            <th><center>Nome da Especificação de Treinamento</center></th>            
...
<script type="text/javascript">
    $(document).ready(function(){
         $('#espectreinamentos_table').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax":"{{ route('espectreinamento.getdata') }}",
            "columns":[
                { "data":  "id", className: "uniqueClassName" },
                { "data":  "nome_espectreinamento", className: "uniqueClassName"},
            ...
            "language":{
                    ...
                    "sInfoPostFix": "",
                    "sInfoThousands": ".",
                    "sLengthMenu": "_MENU_ resultados por página — <b>Tabela</b>: Especificação de Treinamentos",
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm("Tem certeza que deseja deletar esta Especificação de Treinamento?"))
        {
            $.ajax({
                ...
                {
                    alert(data);
                    $('#espectreinamentos_table').DataTable().ajax.reload();
                }
            })
        }
        else
